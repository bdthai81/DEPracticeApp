...
var deupData = [
        ...
        {'answer': 'A',
        'explanation': 'Dimensionality Reduction Techniques is a method to reduce the number of features and is not a Machine Learning Type',
        'id': 2,
        ...
        {'answer': 'B',
        'explanation': 'Please refer GCP ML Services Documentation https://cloud.google.com/products/ai/',
        'id': 3,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/appengine/docs/the-appengine-environments',
        'id': 4,
        'options': ['A. FALSE', 'B. TRUE'],
        'question': 'App Engine Standard environment supports SSH debugging(True/False)'},
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/dataflow/docs/',
        'id': 5,
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/bigqueryml-intro',
        'id': 6,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/storage-options/',
        'id': 7,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/composer/',
        'id': 11,
        'options': ['A. Apache Beam',
        'B. Cloud Composer',
        'C. Apache Crunch',
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/storage/',
        'id': 12,
        'options': ['A. TRUE', 'B. FALSE'],
        'question': 'Google Cloud Storage supports strongly consistent listing(True/False)'},
        {'answer': 'D',
        'explanation': 'Please refer https://cloud.google.com/spanner/docs/audit-logging',
        'id': 13,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/best-practices-costs',
        'id': 17,
        ...
        {'answer': 'C',
        'explanation': 'Bianary Dummy Varible helps convert categorical variable into multiple numerical variables',
        'id': 18,
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/dataflow/',
        'id': 19,
        'options': ['A. Dataflow',
        ...
        {'answer': 'D',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/transfer-service-overview',
        'id': 26,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/pubsub/',
        'id': 28,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'A',
        'explanation': 'Principal components are orthogonal and independent',
        'id': 31,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/datastore/',
        'id': 37,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'D',
        'explanation': 'Please refer https://cloud.google.com/compute/docs/faq',
        'id': 44,
        ...
        {'answer': 'C',
        'explanation': 'Association rules can help create rules on which items are brought together',
        'id': 47,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/memorystore/',
        'id': 50,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/sql/docs/features',
        'id': 51,
        'options': ['A. TRUE', 'B. FALSE'],
        'question': 'Cloud SQL MySQL Instane supports user defined functions(True/False)'},
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/solutions/running-janusgraph-with-bigtable',
        'id': 52,
        'options': ['A. FALSE', 'B. TRUE'],
        'question': 'JanusGraph a Graph Database can use Cloud BigTable as an underlying storage layer(True/False)'},
        {'answer': 'D',
        'explanation': 'Logistic regression can be used to create a classification model in this case',
        'id': 53,
        'options': ['A. Linear Regression',
        'B. Principal Component Analysis',
        'C. Association Rules',
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/functions/',
        'id': 55,
        'options': ['A. Cloud Translation',
        ...
        {'answer': 'A',
        'explanation': 'Clusters identifed can be used as a proxy for multiple features',
        'id': 57,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/dataprep/docs/',
        'id': 59,
        ...
        {'answer': 'C',
        'explanation': 'Clustering algorithms can be used to identify clusters in a data set',
        'id': 64,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/composer/docs/',
        'id': 76,
        ...
        {'answer': 'C',
        'explanation': 'Coefficient of Determination (R Square) is used to evaluate regression models',
        'id': 80,
        ...
        {'answer': 'D',
        'explanation': 'Please refer https://cloud.google.com/spanner/docs/bulk-loading',
        'id': 81,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/datalab/',
        'id': 86,
        ...
        {'answer': 'D',
        'explanation': 'Multiple Regression problem as there are multiple features',
        'id': 87,
        'options': ['A. Principal Component Analysis',
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/pubsub/docs/',
        'id': 88,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/kubernetes-engine/',
        'id': 90,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/storage-transfer/docs/',
        'id': 93,
        'options': ['A. Google Transfer Appliance',
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/solutions/opentsdb-cloud-platform',
        'id': 95,
        'options': ['A. Google Cloud Storage',
        'B. Google Cloud Bigtable',
        'C. Cloud Storage for Firebase',
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/gis-visualize',
        'id': 96,
        ...
        {'answer': 'D',
        'explanation': 'It is based on definition of Reinforcement learning',
        'id': 97,
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/sql/',
        'id': 98,
        ...
        {'answer': 'D',
        'explanation': 'Please refer https://cloud.google.com/iam/docs/resource-hierarchy-access-control',
        'id': 101,
        ...
        {'answer': 'B',
        'explanation': 'The combiner function helps to cut down the amount of data shuffled between the mappers and reducers and is not a replacement for a reducer function',
        'id': 104,
        'options': ['A. TRUE', 'B. FALSE'],
        'question': 'A combiner function is a replacement for a reducer function(True/False)'},
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/bigquery-connector-for-excel',
        'id': 105,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/external-data-sources',
        'id': 108,
        'options': ['A. FALSE', 'B. TRUE'],
        'question': 'Data strored in Parquet or ORC format in Cloud Storage can be queried using BigQuery(True/False)'},
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/trace/docs/',
        'id': 109,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/views-intro',
        'id': 110,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/debugger/',
        'id': 115,
        ...
        {'answer': 'A',
        'explanation': 'Map outputs are intermediate outputs to be consumed by reducer to generate final outputs.Storing intermediate outputs in HDFS would be an overkill due to HDFS replication',
        'id': 116,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'A',
        'explanation': 'The input to a single reduce task is normally the output from multiple mappers',
        'id': 118,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/querying-clustered-tables',
        'id': 121,
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/saving-sharing-queries',
        'id': 122,
        'options': ['A. Private',
        'B. Project-level',
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/quotas#streaming_inserts',
        'id': 123,
        ...
        {'answer': 'B',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/cached-results',
        'id': 124,
        'options': ['A. FALSE', 'B. TRUE'],
        'question': 'BigQuery Query Results will not be cached when your query runs against an external data source(True/False)'},
        {'answer': 'A',
        'explanation': 'Because it males reading records a non local operation and so it is not recommended for Hadoop',
        'id': 125,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/filestore/docs/',
        'id': 127,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/access-control',
        'id': 128,
        ...
        {'answer': 'D',
        'explanation': 'Please refer https://www.tensorflow.org/guide/',
        'id': 129,
        ...
        {'answer': 'A',
        'explanation': 'Please refer https://cloud.google.com/bigquery/docs/querying-wildcard-tables',
        'id': 132,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/transfer-appliance/docs/2.0/',
        'id': 133,
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/iam/docs/testing-permissions',
        'id': 137,
        ...
        {'answer': 'B',
        'explanation': 'YARN supports FIFO,Capacity and Fair Schedulers',
        'id': 145,
        ...
        {'answer': 'B',
        'explanation': 'Hive stores table metadata information in a relational database',
        'id': 147,
        'options': ['A. TRUE', 'B. FALSE'],
        ...
        {'answer': 'C',
        'explanation': 'Please refer https://cloud.google.com/iam/docs/understanding-service-accounts',
        'id': 150,
